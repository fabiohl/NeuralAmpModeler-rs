...
pub use validation::{
    MAX_A2_DYN_BOTTLENECK, MAX_A2_DYN_CHANNELS, MAX_A2_HEAD_CHANNELS, MAX_CONVNET_CHANNELS,
    MAX_CONVNET_KERNEL_SIZE, MAX_DILATION, MAX_DILATIONS_PER_ARRAY, MAX_HEAD_SIZE, MAX_HIDDEN_SIZE,
