...
## 7. Error Catalog (NamErrorCode) — synced Sprint 8 (2026-08-09)
...
|:------- |:-------------------------- |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `E1xxx` | Model loading (I/O, parse) | `E1100` FILE_NOT_FOUND, `E1101` FILE_READ_ERROR, `E1102` UNKNOWN_EXTENSION, `E1200` INVALID_JSON_FORMAT, `E1201` NAMB_CRC32_MISMATCH, `E1202` NAMB_INVALID_MAGIC, `E1203` NAMB_UNSUPPORTED_VERSION, `E1204` NAMB_TRUNCATED, `E1205` NAMB_CRC32_MISSING, `E1206` JSON_WEIGHTS_EXCEED_LIMIT, `E1211` JSON_WEIGHT_NOT_FINITE, `E1214` JSON_INVALID_SAMPLE_RATE, `E1215` JSON_UNSUPPORTED_TOPOLOGY, `E1216` JSON_INVALID_VERSION_FORMAT, `E1217` JSON_UNSUPPORTED_VERSION, `E1218` JSON_UNSUPPORTED_MULTI_CHANNEL, `E1300` UNSUPPORTED_ARCHITECTURE, `E1301` TOPOLOGY_DETECTION_FAILED, `E1302` WEIGHT_COUNT_MISMATCH, `E1303` MODEL_BUILD_FAILED, `E1304` MODEL_TOO_LARGE, `E1305` INVALID_MODEL_TOPOLOGY |
| `E2xxx` | Audio / RT                 | `E2001` PROCESSING_OVERLOAD, `E2100` AUDIO_INIT_FAILED, `E2101` STREAM_ERROR, `E2200` RESAMPLER_BUILD_FAILED, `E2201` RESAMPLER_CHANNEL_FULL, `E2300` RT_PRIORITY_DENIED, `E2301` CPU_AFFINITY_FAILED                                                                                                                       |
