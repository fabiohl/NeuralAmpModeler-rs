...
| `golden_wavenet_a2_max.bin`                  | `wavenet_a2_max.nam`                  | **Official real** (rejected fail-closed; see [docs/cpp_parity_map.md])     | CH=4, cond=8 FiLM, 23 layers                                            |
...
| No v2 golden (`v2_scope=none`)                    | `a2_dynamic_gated_ch8`, `a2_dynamic_blended_ch3`, `wavenet_a2_film_full`, `wavenet_a2_film_lite`, `wavenet_a2_film_chaos_stress`, `wavenet_a2_film_input_mixin_pre`, `a2_example`, `linear_fft_rf{320,2048,4096,8192}`, `wavenet_a1_secondary_act`, `wavenet_condition_lstm` |
