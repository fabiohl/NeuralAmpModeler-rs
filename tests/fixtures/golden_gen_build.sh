...
# truth). Models with skip_reason set are skipped cleanly in both v1
# and v2 loops.
...
# ── EXPECTED golden files (Freshness Gate) ──
...
# Expands manifest coverage to all synthetic fixture data
...
# Hash the source code of every fixture generator.
...
# Complete listing of every .nam model known to this
