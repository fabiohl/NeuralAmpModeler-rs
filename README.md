...
| [`utils/verify_no_avx512_release.sh`](utils/verify_no_avx512_release.sh) | **Binary Surface Guard:** Scans compiled release artifacts using `llvm-nm`/`llvm-objdump` to verify zero AVX-512 symbols and zero EVEX/ZMM instructions in default builds.                                                                                                                                                                                                                                                                                                               |
